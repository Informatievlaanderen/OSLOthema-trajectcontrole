...
- De herbruikbare [JSON-LD context](https://implementatie.data.vlaanderen.be/doc/implementatiemodel/magda/voertuigregistratie/v0.1.0/context/voertuigregistratie.jsonld) en het [SHACL template](https://implementatie.data.vlaanderen.be/doc/implementatiemodel/magda/voertuigregistratie/v0.1.0/shacl/voertuigregistratie-SHACL.ttl) van het implementatiemodel.
